        ...
        <div>
            <div className='row'>
                <div className=' col-lg-7 col-sm-12'>
                    <div className='float-end text-center mt-5'>
                    <p className='h1'>Consolidate tools. <br />
                      Cut costs.</p>
                    </div>
                </div>
...
<div className='row'>
<div className='col-6 '>
    <img className='float-end' src="https://www.notion.so/cdn-cgi/image/format=webp,width=128/front-static/shared/logos/color/metalab.png" alt="" />
</div>
<div style={{fontSize:"15px",lineHeight:"10px"}} className='col-6'>
    <p className='fw-semibold'>Justin Watt</p>
